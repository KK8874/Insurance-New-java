                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                     <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="LapsCheck.jsp">LapsCheck</a>
                        </li>

                       <li class="nav-item">
                            <a class="nav-link click-scroll" href="LapsHistory.jsp">LapsHistory</a>
                        </li>
                       <li class="nav-item">
                            <a class="nav-link click-scroll" href="ViewRefunds.jsp">View Refunds</a>
                        </li>
