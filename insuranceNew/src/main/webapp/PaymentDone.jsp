...
<h5>Confrimation of payment</h5>

<form method="get"  id="login-form"  action="PaymentDone.jsp">
    Payment Id : 
	...
	<input type="submit" class="form-control" value="Confirm Payment" onclick="alert('Payment Successfull')";/>
