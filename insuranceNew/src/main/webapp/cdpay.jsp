                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                     <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="PaymentDetailsNew.jsp">Check Payment</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="ShowParticularPayment.jsp">Payment History</a>
                        </li>
