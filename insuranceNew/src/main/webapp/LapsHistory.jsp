...
<center>  <h5><b>View lapsed history</b> </h5></center>
...
<c:forEach var="books" items="${beanDao.showBookingDetails2(sessionScope.user)}">
<tbody>
<tr>
<td><c:out value="${books.bookingId}"/></td>

<td><c:out value="${books.policyID}"/></td>
