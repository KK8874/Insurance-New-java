...
<h2>Payment Check</h2>
	<form method="get"  id="login-form" action="PaymentDetailsNew2Dummy.jsp" style="align:center;">
	PolicyName :
		<select name="policyName"  required>
